...
There are way over 200 different effects that can happen, and the list is only growing with each update! Anything from giving the player health, to teleporting them, changing the physics, removing car wheels, making the whole world spin and much more.

[A full documented list of effects can be found here.](https://zolika1351.pages.dev/chaos/nfs)

![pic](https://user-images.githubusercontent.com/10864159/214846924-8eaea825-6965-4683-8b1b-bc3757c6309d.png)
